...
const PROJECTS = [
  {
    ...
    desc: "Professional e-commerce web development solution.",
    url: "https://webcomforts.com",
    img: "/images/webcomforts-logo.png",
    tags: ["Shopify", "React", "SEO"],
    icon: Store
  },
  {
    name: "Vapesuite",
    domain: "Retail Branding",
    desc: "Customized storefront for vape retail brand.",
    url: "https://vapesuite.com",
    img: "/images/vapesuite-logo.png",
    tags: ["Shopify", "Design"],
    icon: Store
  }
];
